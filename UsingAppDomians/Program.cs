...
namespace UsingAppDomians
{
    ...
    {
        static AppDomain Drawer; //будет хранить объект домена приложения
                                 //TextDrawer
        ...
        static void Main()
        {
            ...
            DrawerWindow =
           Activator.CreateInstance(DrawerAsm.GetType("TextDrawer.Form1")) as Form;
