...
namespace TextDrawer
{
    public partial class Form1 : Form
    {
        ...
        private void Panel1_Paint(object sender, PaintEventArgs e)
        {
            if (SourceText.Length > 0)
            {
                ...
                * клиентской части элемента управления Panel*/
                ...
                /*прорисовываем на элементе кправления Panel
                *текст используя выбранный шрифт*/
                imgDC.DrawString(SourceText, DrawingFont, Brushes.Brown,
                ClientRectangle,
        ...
        public void Move(Point newLocation, int width)
        {
            ...
            this.Invoke((Action)delegate () { this.Location = newLocation; this.Width = width; });
